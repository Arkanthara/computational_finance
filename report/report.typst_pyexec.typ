...
#figure(grid(columns: 2, [#figure(image(".typst_pyexec/figures/cell_12_1_1.svg"), kind: "subfigure", caption: [Directional changes returns])], [#figure(image(".typst_pyexec/figures/cell_12_1_2.svg"), kind: "subfigure", caption: [Daily returns])]), caption: [Histograms of sets of returns], kind: image)
